    ...
    countdownInterval = setInterval(() => {
        if (!paused) {
            ...
            if (countdown <= 0) {
                ...
                // إظهار الرسالة بعد عرض الروابط
                const messageAfterLinks = document.getElementById("message-after-links");
                messageAfterLinks.style.display = "block"; // إظهار الرسالة بعد عرض الروابط
